  ...
  return (
    <>
      <div id='about'>
        ...
        {/* About */ }
        <div
          className="pt-[100px] pb-[100px] lg:pb-[600px] relative lg:h-[800px] pr-2 pl-2"
          style={ {
        ...
        >
          ...
          <div className='max-w-screen-xl m-auto md:grid grid-cols-3 gap-8'>
            ...
            <div className='col-span-2'>
              ...
              <div className='w-full bg-transparent flex flex-col md:flex-row items-center justify-center md:justify-start rounded-xl pb-5'>
                <Image
                  className=''
                  width={ 280 }
                  height={ 280 }
